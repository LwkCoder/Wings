package com.lwkandroid.wingsdemo.utils.element;
...
import com.lwkandroid.wingsdemo.utils.element.transition.DefaultShareElementTransitionFactory;
import com.lwkandroid.wingsdemo.utils.element.transition.IShareElementSelector;
import com.lwkandroid.wingsdemo.utils.element.transition.IShareElementTransitionFactory;
...
public class YcShareElement
{
    ...
    public static void setEnterTransitions(@NonNull final Activity activity,
                                           @Nullable final IShareElements IShareElements,
                                           boolean postponeTransition,
    ...
    public static void onActivityReenter(final Activity activity, int resultCode, Intent data, IShareElementSelector selector)
    {
        ...
        //原库实现如下，但在配合透明主题，查看大图的时候按下Home键后再回到界面，此后点击Back键无法关闭该界面
