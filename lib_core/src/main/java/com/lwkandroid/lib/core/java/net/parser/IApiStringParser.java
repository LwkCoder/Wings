...
public interface IApiStringParser
{
    ...
    /**
     * 将结果解析为{@link com.lwkandroid.lib.core.java.net.bean.IApiRestfulResult}，并获取Object类型数据
     *
     * @param dataClass 对象的Class
     * @param <T>       对象泛型
     */
    ...
    /**
     * 将结果解析为{@link com.lwkandroid.lib.core.java.net.bean.IApiRestfulResult}，并获取Object类型集合数据
     *
     * @param dataClass 对象的Class
     * @param <T>       对象泛型
     */
