package com.lwkandroid.wings.widget.ptr;
 ...
 * <li>可在 xml 中使用 {@link com.lwkandroid.wings.R.styleable#PTRLayout} 这些属性或在 Java 设置对应的属性决定子View的开始位置、触发刷新的位置等值</li>
 * </ul>
 *
 * @author cginechen
 * @date 2016-12-11
...
public class PTRLayout extends ViewGroup implements NestedScrollingParent
{
    ...
    public void requestDisallowInterceptTouchEvent(boolean b)
    {
        ...
        if ((android.os.Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP && mTargetView instanceof AbsListView)
